...
public class AwesomiumUnityWebView
{
    ...
    extern static private void awe_webview_copyclipboard(System.IntPtr _Instance);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    extern static private void awe_webview_pasteclipboard(System.IntPtr _Instance);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    extern static private void awe_webview_cutclipboard(System.IntPtr _Instance);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    extern static private void awe_webview_undo(System.IntPtr _Instance);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    extern static private void awe_webview_redo(System.IntPtr _Instance);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    extern static private void awe_webview_selectall(System.IntPtr _Instance);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    extern static private void awe_webview_zoomin(System.IntPtr _Instance);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    extern static private void awe_webview_zoomout(System.IntPtr _Instance);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    extern static private void awe_webview_zoomreset(System.IntPtr _Instance);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    extern static private void awe_webview_requestpageinfo(System.IntPtr _Instance);
    #endregion
    ...
    #region ExtraMethods_Callable
    public void CopyClipboard()
    {
        awe_webview_copyclipboard(m_Instance);
    }

    public void PasteClipboard()
    {
        awe_webview_pasteclipboard(m_Instance);
    }

    public void CutClipboard()
    {
        awe_webview_cutclipboard(m_Instance);
    }

    public void Undo()
    {
        awe_webview_undo(m_Instance);
    }

    public void Redo()
    {
        awe_webview_redo(m_Instance);
    }

    public void SelectAll()
    {
        awe_webview_selectall(m_Instance);
    }

    public void ZoomIn()
    {
        awe_webview_zoomin(m_Instance);
    }

    public void ZoomOut()
    {
        awe_webview_zoomout(m_Instance);
    }

    public void ZoomReset()
    {
        awe_webview_zoomreset(m_Instance);
    }

    public void RequestPageInfo()
    {
        //not working
        awe_webview_requestpageinfo(m_Instance);
    }
    #endregion
