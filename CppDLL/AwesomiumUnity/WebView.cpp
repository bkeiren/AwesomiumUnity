...
//Extra Methods
extern "C" EXPORT_API void awe_webview_copyclipboard(WebView* _Instance)
{
    if (_Instance)
    {
        _Instance->Copy();
...
extern "C" EXPORT_API void awe_webview_pasteclipboard(WebView* _Instance)
{
    if (_Instance)
    {
        _Instance->Paste();
...
extern "C" EXPORT_API void awe_webview_cutclipboard(WebView* _Instance)
{
    if (_Instance)
    {
        _Instance->Cut();
...
extern "C" EXPORT_API void awe_webview_undo(WebView* _Instance)
{
    if (_Instance)
    {
        _Instance->Undo();
...
extern "C" EXPORT_API void awe_webview_redo(WebView* _Instance)
{
    if (_Instance)
    {
        _Instance->Redo();
...
extern "C" EXPORT_API void awe_webview_selectall(WebView* _Instance)
{
    if (_Instance)
    {
        _Instance->SelectAll();
...
extern "C" EXPORT_API void awe_webview_zoomin(WebView* _Instance)
{
    if (_Instance)
    {
        _Instance->ZoomIn();
...
extern "C" EXPORT_API void awe_webview_zoomout(WebView* _Instance)
{
    if (_Instance)
    {
        _Instance->ZoomOut();
...
extern "C" EXPORT_API void awe_webview_zoomreset(WebView* _Instance)
{
    if (_Instance)
    {
        _Instance->ResetZoom();
...
extern "C" EXPORT_API void awe_webview_requestpageinfo(WebView* _Instance)
{
    if (_Instance)
    {
        _Instance->RequestPageInfo();
    }
}
